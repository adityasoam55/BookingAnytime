        ...
        <div className='relative'>
            <section className="bg-cover bg-center h-96" >
                <div className="h-full flex flex-col justify-center items-center text-center text-white">
                    ...
                    <div className='absolute w-full max-w-5xl max-sm:p-2 '>
                        <div className='flex flex-col place-items-start text-left gap-3'>
                            <h1 className="text-5xl max-sm:text-2xl font-bold">The perfect home base <br /> for your special trip</h1>
                            <p className="text-2xl max-sm:text-lg font-medium mt-2">Discover dreamy holiday homes all over the world</p>
